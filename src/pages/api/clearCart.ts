...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
	...
	if (req.method === "DELETE") {
		console.log("Preparing to send request to external API for clearing the cart:");
		try {
			const apiResponse = await axios.delete(`https://api.sunsetcinema.in-create.online/api/en/clear-cart`, {
