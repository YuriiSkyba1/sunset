	...
	return (
		<div className="px-4 py-10 desktop:px-[60px] desktop:py-20 desktop:flex desktop:justify-between desktop:gap-6">
			<div className="flex flex-1 flex-col gap-5 desktop:gap-10">
				<div className="w-full max-w-[227px] text-[24px] leading-[32px] font-bold uppercase desktop:max-w-[366px] desktop:text-[40px] desktop:leading-[48px]">
				...
				<div className="bg-[#F9F8F9] p-4 flex flex-col gap-4 desktop:py-8 desktop:px-6 desktop:grid desktop:grid-cols-2 desktop:gap-x-6 desktop:gap-y-8 ">
					<div className="w-full desktop:max-w-[288px]">
						<div className="flex gap-2 font-bold uppercase text-[10px] leading-[18px] mb-[6px] desktop:text-[12px] desktop:mb-3">
							<Image src={LocationIcon} alt="LocationIcon" />
							Location
						</div>
						<div className="desktop:text-[16px] desktop:leading-6">{renderingData?.address}</div>
					</div>
					<div className='w-full desktop:max-w-[288px]"'>
						<div className="flex gap-2 font-bold uppercase text-[10px] leading-[18px] mb-[6px]  desktop:text-[12px] desktop:mb-3">
						...
						<div className="desktop:text-[16px] desktop:leading-6">{renderingData?.email}</div>
					</div>
					<div className='w-full desktop:max-w-[288px]"'>
						<div className="flex gap-2 font-bold uppercase text-[10px] leading-[18px] mb-[6px] desktop:text-[12px] desktop:leading-[18px] desktop:mb-3">
							<Image src={PhoneIcon} alt="PhoneIcon" />
							Phone number
						</div>
						<div className="desktop:text-[16px] desktop:leading-6">{renderingData?.phone}</div>
					</div>
					<div className='w-full desktop:max-w-[288px]"'>
						<div className="flex gap-2 font-bold uppercase text-[10px] leading-[18px] mb-[6px] desktop:text-[12px] desktop:mb-3">
