	...
	return (
		<div className="px-4 py-10 desktop:px-[60px] desktop:pt-20 desktop:pb-40 desktop:flex desktop:justify-between desktop:gap-6">
			<div className="flex-1 ">
				<div className="text-[24px] leading-[32px] mb-1 uppercase font-druk_wide desktop:text-[40px] desktop:leading-[48px] desktop:mb-6">
					feedback form
					<Image src={Underline} alt="Underline" className="w-full max-w-[536px]" />
				</div>
				<div className="font-gotham_pro_regular text-[16px] leading-6 mb-8 desktop:text-[18px] desktop:leading-[28px] desktop:mb-14">
